...
🔍 Current Focus: Building an end-to-end Loan Default Risk Pipeline using Azure Data Lake, MLflow, and Power BI

**📝 Blog** 
---
 
Description: I occasionally share learnings and project breakdowns around data pipelines, ML systems, and Power BI on my blog.  
📎 Link to my blog: *Coming soon*
**📂 Projects**  
...
Highlights:  
- Showed active vs inactive logins over the last 12 months  
- Used calculated tables and bookmarks for top-N breakdowns  
🔗 [Link to project repository](https://github.com/Adrshp806/LoginActivityAnalysis)
...
Highlights:  
- Event-driven architecture using streaming and batch layers  
- Scheduled transformations with Cloud Composer (Airflow)  
🔗 [Link to project repository](https://github.com/Adrshp806/RealTimePipeline-GCP)
...
Highlights:  
- Simulated UK pension member data and built predictive risk metrics  
- Interactive dashboard for fund contribution and engagement trends  
🔗 [Link to project repository](https://github.com/Adrshp806/PensionRiskPipeline)
...
🔗 [Link to project repository](https://github.com/Adrshp806/KidneyDisease_Classification)
...
Highlights:  
- Trained multiple models (logistic regression, ensemble models)  
- User-friendly frontend for real-time prediction  
🔗 [Link to project repository](https://github.com/Adrshp806/ChurnPredictionApp)

**🛠 Skills**  
---

Programming Languages: Python, SQL, Scala  
Big Data: Spark, PySpark, Kafka  
Cloud: Azure (ADF, Synapse, Databricks), GCP (BigQuery, Composer), AWS (Glue, S3, Redshift)  
...
📎 LinkedIn: [Adarsh Pandey](https://www.linkedin.com/in/adarshpandey-ds)  
📧 Email: adarshp806@gmail.com
📍 Location: London, UK  

Feel free to explore my projects and reach out if you’d like to connect, collaborate, or talk shop!
